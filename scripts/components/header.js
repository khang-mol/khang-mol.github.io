import { addGlobalEventListener } from "./allComponents.js";
...
export function renderHeader() {
  ...
  function renderNavbar() {
    ...
    (() => {
      function getNavbarHeight() {
        return document.querySelector(".primary-navigation").offsetHeight || 0;
      };
  ...
  class Header extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // shadowRoot.appendChild(document.importNode(headerTemplate.content, true));
    };
  };
